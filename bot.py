...
US_POLITICS_SOURCES = [
    ...
    ("Christian Science Monitor", "https://rss.csmonitor.com/feeds/usa"),
    ("The Hill", "https://thehill.com/rss"),
    ("CNBC", "https://www.cnbc.com/id/100003114/device/rss/rss.html"),
    ("Forbes", "https://www.forbes.com/feed/rss/"),
    ...
    ("The Philadelphia Inquirer", "https://www.inquirer.com/rss"),
    ("The Seattle Times", "https://www.seattletimes.com/rss"),
    ("The Denver Post", "https://www.denverpost.com/rss"),
    ("The Arizona Republic", "https://www.azcentral.com/rss"),
    ("The Star Tribune Minneapolis", "https://www.startribune.com/rss"),
    ("The Oregonian", "https://www.oregonlive.com/rss"),
    ("The Sacramento Bee", "https://www.sacbee.com/rss"),
    ("The San Francisco Chronicle", "https://www.sfchronicle.com/rss"),
    ("The Dallas Morning News", "https://www.dallasnews.com/rss"),
    ("The Atlanta Journal-Constitution", "https://www.ajc.com/rss"),
    ("The Miami Herald", "https://www.miamiherald.com/rss"),
    ("ProPublica", "https://www.propublica.org/feeds/propublica/main"),
    ("Pew Research Center", "https://www.pewresearch.org/feed"),
    ("Brookings Institution", "https://www.brookings.edu/feed/"),
    ("RAND Corporation", "https://www.rand.org/rss/"),
    ("Council on Foreign Relations", "https://www.cfr.org/feed"),
    ("The Texas Tribune", "https://www.texastribune.org/rss"),
    ("Politico Magazine", "https://www.politico.com/rss/politicopicks.xml"),
    ("Roll Call", "https://rollcall.com/rss"),
    ("CQ Roll Call", "https://cqrollcall.com/rss"),
    ("National Journal", "https://www.nationaljournal.com/rss"),
    ("The Cook Political Report", "https://cookpolitical.com/rss"),
    ("Ballotpedia", "https://ballotpedia.org/feed"),
    ("RealClearPolitics", "https://www.realclearpolitics.com/rss"),
    ("FactCheck.org", "https://www.factcheck.org/feed"),
    ("PolitiFact", "https://www.politifact.com/rss/all/"),
    ("Snopes politics section", "https://www.snopes.com/feed/"),
    ("The Dispatch", "https://thedispatch.com/feed"),
    ("Notus", "https://notus.org/feed"),
    ("Punchbowl News", "https://punchbowl.news/feed"),
    ("Semafor", "https://www.semafor.com/feed"),
    ("Puck News", "https://puck.news/feed"),
    ...
    ("NewsGuard-rated national outlets", "https://news.google.com/rss/search?q=newsguard+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("McClatchy DC Bureau", "https://news.google.com/rss/search?q=mcclatchy+dc+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Hearst Newspapers Washington Bureau", "https://news.google.com/rss/search?q=hearst+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Gannett DC Bureau", "https://news.google.com/rss/search?q=gannett+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("Bloomberg Government", "https://news.google.com/rss/search?q=bloomberg+government+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("The Cipher Brief", "https://news.google.com/rss/search?q=the+cipher+brief+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Just Security", "https://news.google.com/rss/search?q=just+security+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Lawfare Blog", "https://www.lawfaremedia.org/feed"),
    ("SCOTUSblog", "https://www.scotusblog.com/feed/"),
    ("OpenSecrets.org campaign finance", "https://www.opensecrets.org/rss"),
    ("The Markup tech policy", "https://news.google.com/rss/search?q=the+markup+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Stateline state-federal policy", "https://news.google.com/rss/search?q=stateline+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Governing Magazine", "https://news.google.com/rss/search?q=governing+magazine+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Route Fifty federal workforce", "https://news.google.com/rss/search?q=route+fifty+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Government Executive", "https://news.google.com/rss/search?q=government+executive+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("Defense One", "https://news.google.com/rss/search?q=defense+one+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("War on the Rocks", "https://news.google.com/rss/search?q=war+on+the+rocks+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("National Defense Magazine", "https://news.google.com/rss/search?q=national+defense+magazine+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Foreign Policy Situation Report", "https://news.google.com/rss/search?q=foreign+policy+situation+report+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
