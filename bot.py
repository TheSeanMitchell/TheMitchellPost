...
for source_name, url in ALL_SOURCES:
    ...
    for attempt in range(3):
        try:
            ...
            if feed.bozo:
                print(f"  Feed bozo error for {source_name}")
                break
...
print("\nScript finished.")
print("Look in folder: C:\\Users\\mitch\\OneDrive\\Desktop\\News Automation Folder")
print("Double-click news_feed.html or index.html to open in browser.")
