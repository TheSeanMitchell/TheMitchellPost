...
RAW_US_KEYWORDS = [
    # === YOUR ORIGINAL LIST — UNCHANGED, ALL KEPT ===
    ...
    "trump tariffs", "elon musk", "jd vance", "maga movement", "deep state", "fake news", "cancel culture", "woke agenda", "dei backlash", "transgender rights debate", "abortion ban", "gun rights", "second amendment", "border crisis", "illegal immigration", "election fraud claims", "voter id laws", "supreme court ruling", "roe v wade overturn", "big tech censorship", "section 230 reform", "twitter files", "joe rogan podcast", "tucker carlson show", "fox news bias", "cnn propaganda", "msnbc meltdown", "inflation spike", "recession warning", "stock market crash", "bitcoin crypto", "ev mandate", "climate change hoax", "green new deal", "ozempic weight loss", "big pharma corruption", "vaccine injury claims", "covid lab leak", "ukraine aid package", "israel gaza war", "china trade war", "tariffs on china", "hollywood elite", "celebrity political endorsement", "oscars controversy", "met gala fashion", "red carpet drama", "celebrity scandal", "paparazzi photos", "viral tiktok trend", "social media outrage", "ai deepfake", "chatgpt regulation", "tesla stock", "elon musk trump", "vance vp", "maga rally", "trump assassination attempt", "secret service failure", "fbi investigation", "doj corruption", "impeachment talk", "government shutdown threat", "national debt ceiling", "tax cuts for rich", "student loan forgiveness", "campus protest", "free speech on campus", "civil rights movement", "black lives matter", "defund the police", "qualified immunity", "police reform", "criminal justice", "prison reform", "death penalty", "fentanyl crisis", "border fentanyl", "cartel violence", "asylum seeker", "deportation flight", "sanctuary city", "immigration court backlog", "daca dreamers", "visa overstays", "chain migration", "h1b visa abuse", "tech worker replacement", "ai job loss", "automation unemployment", "gig economy", "minimum wage hike", "union strike", "labor shortage", "skills gap", "education reform", "charter school", "school choice", "curriculum battle", "critical race theory", "gender ideology", "trans athlete", "women sports", "title ix", "biological sex", "pronoun debate", "cancel culture hollywood", "me too movement", "metoo fallout", "oscars boycott", "celebrity virtue signaling", "woke disney", "bud light boycott", "target boycott", "nike controversy", "big tech monopoly", "google antitrust", "amazon breakup", "facebook censorship", "twitter rebrand x", "elon musk free speech", "section 230 repeal", "ai regulation bill", "chatgpt bias", "deepfake election", "misinformation law", "fact checkers bias", "mainstream media decline", "alternative media rise", "podcast boom", "youtube politics", "tiktok ban bill", "china spy", "balloon incident", "taiwan invasion risk", "ukraine funding", "israel aid", "gaza ceasefire", "hamas hostage", "iran nuclear", "saudi normalization", "abraham accords", "climate emergency", "green energy subsidy", "ev tax credit", "gas price spike", "oil production", "strategic petroleum reserve", "inflation reduction act", "build back better", "infrastructure bill", "chip act", "semiconductor shortage", "tesla robotaxi", "elon musk mars", "space x launch", "nasa artemis", "moon mission", "satellite internet", "starlink ukraine", "cyber attack", "ransomware", "data breach", "identity theft", "privacy law", "facial recognition", "surveillance state", "fbi whistleblower", "deep state", "qanon", "conspiracy theory", "election denial", "jan 6 committee", "capitol riot", "impeachment", "hunter biden", "laptop from hell", "burisma", "big pharma", "pfizer", "moderna", "vaccine mandate", "mask mandate", "lockdown", "covid origin", "lab leak theory", "gain of function", "who pandemic treaty", "global health", "obesity epidemic", "ozempic shortage", "weight loss drug", "mental health crisis", "suicide rate", "opioid epidemic", "fentanyl death", "cartel", "mexico border", "wall construction", "deportation", "ice raid", "sanctuary", "dream act", "amnesty", "chain migration", "h1b visa", "tech visa abuse", "ai job replacement", "automation", "universal basic income", "ubi debate", "minimum wage", "living wage", "union power", "strike wave", "labor shortage", "skills gap", "student debt", "loan forgiveness", "pell grant", "college", "university", "campus protest", "encampment", "free speech", "title ix", "trans athlete", "woman sports", "fairness", "biological woman", "pronoun", "bathroom", "locker room", "abortion", "roe v wade", "dobbs", "ban", "pill", "mifepristone", "gun control", "assault weapon", "background check", "red flag", "second amendment", "nra", "crime", "carjacking", "smash and grab", "shoplifting", "fentanyl", "opioid", "cartel", "mexico border", "wall", "deport", "ice", "asylum", "daca", "visa", "h1b", "chain", "amnesty", "supreme court", "justice", "alito", "thomas", "roberts", "kavanaugh", "barrett", "gorsuch", "sotomayor", "kagan", "jackson", "ruling", "decision", "landmark", "impeachment", "house", "senate", "filibuster", "reconciliation", "shutdown", "debt ceiling", "tax cut", "corporate", "rich", "middle class", "social security", "medicare", "medicaid", "obamacare", "aca", "drug price", "insulin", "big pharma", "vaccine", "mandate", "mask", "mandate", "lockdown", "lab", "leak", "gain", "function", "who", "pandemic", "treaty", "global", "health", "ozempic", "weight", "loss", "obesity", "mental", "health", "suicide", "depression", "anxiety", "therapy", "telehealth", "ai", "doctor", "chatgpt", "therapy", "deepfake", "porn", "revenge", "porn", "onlyfans", "adult", "content", "celebrity", "leak", "paparazzi", "red", "carpet", "oscars", "met", "gala", "fashion", "influencer", "tiktok", "instagram", "youtube", "podcast", "rogan", "tucker", "fox", "cnn", "msnbc", "the", "view", "daily", "show", "colbert", "kimmel", "fallon", "snl", "oscars", "met", "gala", "red", "carpet", "fashion", "controversy", "viral", "moment", "meme", "tiktok", "challenge", "cancel", "outrage", "twitter", "x", "facebook", "instagram", "onlyfans", "adult", "content", "creator", "monetization", "subscription", "fan", "engagement", "celebrity", "net", "worth", "scandal", "leak", "paparazzi", "photo", "video", "viral", "clip", "interview", "podcast", "rogan", "tucker", "fox", "newsmax", "oann", "cnn", "msnbc", "bias", "fake", "news", "mainstream", "legacy", "alternative", "independent", "journalism", "fact", "check", "misinformation", "disinformation", "deep", "state", "conspiracy", "qanon", "election", "fraud", "integrity", "voter", "id", "mail", "in", "absentee", "early", "suppression", "turnout", "red", "wave", "blue", "wave", "purple", "battleground", "swing", "state", "polling", "average", "forecast", "election", "cycle", "primary", "caucus", "delegate", "convention", "platform", "republican", "democratic", "independent", "candidate", "third", "party", "libertarian", "green", "ideology", "conservatism", "liberalism", "populism", "nationalism", "globalization", "isolationism", "polarization", "bipartisan", "cooperation", "gridlock", "judicial", "review", "constitutional", "amendment", "civil", "criminal", "case", "precedent", "supreme", "court", "majority", "dissent", "opinion", "oral", "argument", "brief", "filing", "appeal", "justice", "department", "attorney", "general", "prosecution", "white", "collar", "fraud", "insider", "trading", "financial", "crime", "corruption", "ethics", "reform", "transparency", "whistleblower", "accountability", "trust", "government", "civic", "participation", "voter", "registration", "turnout", "campaign", "volunteer", "grassroots", "activism", "organizing", "community", "engagement", "forum", "town", "hall", "citizen", "initiative", "referendum", "civic", "tech", "open", "government", "data", "watchdog", "nonprofit", "reporting", "independent", "journalism", "media", "ecosystem", "consumption", "trend", "credibility", "source", "verification", "fact", "based", "reporting", "evidence", "based", "policy", "expert", "interview", "data", "driven", "journalism", "public", "record", "access", "foia", "disclosure", "leak", "investigation", "insider", "information", "politics", "anonymous", "source", "verification", "expert", "panel", "discussion", "policy", "expert", "interview", "think", "tank", "analysis", "report", "academic", "research", "publication", "peer", "review", "study", "policy", "longitudinal", "policy", "study", "statistical", "modeling", "politics", "predictive", "analytics", "election", "forecasting", "election", "polling", "aggregator", "polling", "average", "trendline", "analysis", "politics", "sentiment", "analysis", "politics", "social", "media", "sentiment", "voter", "sentiment", "tracking", "demographic", "breakdown", "polling", "age", "group", "voting", "trend", "income", "level", "voting", "trend", "education", "level", "voting", "trend", "geographic", "voting", "pattern", "urban", "voting", "pattern", "suburban", "voting", "pattern", "rural", "voting", "pattern", "regional", "political", "trend", "state", "by", "state", "analysis", "county", "level", "result", "precinct", "level", "result", "electoral", "shift", "realignment", "politics", "coalition", "building", "politics", "party", "strategy", "shift", "ideological", "shift", "us", "progressive", "movement", "conservative", "movement", "libertarian", "movement", "populist", "movement", "centrist", "politics", "moderate", "voter", "swing", "voter", "influence", "independent", "voter", "trend", "partisan", "loyalty", "party", "identification", "trend", "political", "branding", "candidate", "branding", "image", "management", "politics", "crisis", "communication", "politics", "damage", "control", "messaging", "rapid", "response", "team", "politics", "opposition", "messaging", "negative", "campaigning", "attack", "ad", "campaign", "narrative", "storytelling", "politics", "speechwriting", "strategy", "rhetorical", "framing", "public", "persuasion", "technique", "media", "appearance", "strategy", "interview", "strategy", "politics", "debate", "preparation", "mock", "debate", "talking", "point", "strategy", "policy", "communication", "legislative", "messaging", "executive", "messaging", "judicial", "messaging", "public", "relation", "campaign", "government", "reputation", "management", "politics", "approval", "rating", "tracking", "disapproval", "rating", "trend", "favorability", "shift", "trust", "in", "government", "institutional", "trust", "trust", "in", "media", "polarization", "metric", "polarization", "study", "echo", "chamber", "media", "filter", "bubble", "algorithm", "influence", "news", "platform", "algorithm", "politics", "content", "distribution", "news", "virality", "factor", "politics", "news", "amplification", "media", "bias", "analysis", "ideological", "bias", "tracking", "balanced", "reporting", "standard", "neutrality", "in", "journalism", "objectivity", "standard", "sourcing", "standard", "journalism", "editorial", "independence", "newsroom", "practice", "newsroom", "ethics", "reporting", "guideline", "correction", "tracking", "transparency", "in", "reporting", "public", "editor", "report", "ombudsman", "review", "audience", "trust", "metric", "subscriber", "trend", "news", "paywall", "journalism", "nonprofit", "journalism", "model", "public", "broadcasting", "funding", "media", "ownership", "structure", "consolidation", "media", "independent", "outlet", "growth", "startup", "journalism", "local", "news", "decline", "news", "desert", "regional", "news", "coverage", "hyperlocal", "journalism", "investigative", "series", "longform", "reporting", "documentary", "journalism", "multimedia", "journalism", "data", "visualization", "news", "graphic", "reporting", "interactive", "journalism", "live", "blog", "news", "real", "time", "update", "politics", "breaking", "alert", "system", "push", "notification", "news", "daily", "briefing", "politics", "morning", "newsletter", "evening", "recap", "weekly", "political", "analysis", "monthly", "outlook", "report", "annual", "political", "forecast", "election", "cycle", "tracking", "policy", "cycle", "tracking", "legislative", "calendar", "congressional", "schedule", "court", "calendar", "regulatory", "calendar", "budget", "cycle", "fiscal", "year", "planning", "appropriation", "timeline", "campaign", "calendar", "primary", "calendar", "update", "caucus", "timing", "debate", "schedule", "convention", "planning", "inauguration", "timeline", "transition", "planning", "government", "cabinet", "formation", "process", "agency", "leadership", "appointment", "senate", "confirmation", "confirmation", "hearing", "appointment", "controversy", "resignation", "politics", "firing", "politics", "leadership", "change", "government", "succession", "planning", "politics", "emergency", "succession", "plan", "continuity", "of", "government", "crisis", "governance", "disaster", "governance", "wartime", "governance", "emergency", "power", "executive", "authority", "limit", "legislative", "authority", "limit", "judicial", "authority", "limit", "constitutional", "crisis", "separation", "of", "powers", "conflict", "check", "and", "balance", "dispute", "federal", "vs", "state", "power", "state", "sovereignty", "debate", "interstate", "conflict", "policy", "federal", "mandate", "state", "resistance", "policy", "legal", "challenge", "state", "supreme", "court", "appeal", "state", "constitutional", "amendment", "proposal", "amendment", "ratification", "process", "constitutional", "interpretation", "debate", "legal", "scholarship", "constitutional", "law", "judicial", "review", "analysis", "precedent", "analysis", "law", "landmark", "case", "analysis", "comparative", "constitutional", "law", "international", "law", "us", "treaty", "obligation", "us", "global", "governance", "role", "us", "diplomatic", "relation", "tracking", "embassy", "activity", "consulate", "activity", "diplomatic", "statement", "foreign", "leader", "meeting", "us", "summit", "coverage", "international", "agreement", "sanction", "enforcement", "tracking", "export", "control", "enforcement", "border", "policy", "enforcement", "immigration", "enforcement", "action", "custom", "enforcement", "trade", "enforcement", "economic", "sanction", "impact", "global", "economic", "impact", "us", "policy", "domestic", "economic", "impact", "policy", "social", "impact", "policy", "long", "term", "policy", "outcome", "policy", "success", "metric", "policy", "failure", "analysis", "reform", "proposal", "legislative", "reform", "regulatory", "reform", "institutional", "reform", "governance", "innovation", "digital", "government", "e", "government", "service", "public", "service", "delivery", "government", "efficiency", "bureaucratic", "reform", "performance", "metric", "government", "accountability", "mechanism", "transparency", "initiative", "anti", "corruption", "measure", "ethics", "reform", "government", "public", "sector", "innovation", "civic", "technology", "tool", "open", "data", "platform", "digital", "transparency", "citizen", "engagement", "platform",
    # === NEW EXPANSIVE ADDITIONS — focused on 2026 realities ===
    # Trump 2.0 / America First core
    ...
    # Defense / Military / Industrial Base
    "national defense strategy", "2026 nds", "defense industrial base", "dib revitalization", "defense budget increase", "burden sharing allies", "nuclear modernization", "third nuclear era", "defense industrial base", "supercharge dib", "warrior ethos",

    # Broader security / Emerging threats
    ...
    # General policy / think-tank style
...
US_POLITICS_SOURCES = [
    ...
    ("NPR", "https://news.google.com/rss/search?q=npr+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("PBS NewsHour", "https://news.google.com/rss/search?q=pbs+newshour+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("CBS News", "https://news.google.com/rss/search?q=cbs+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("ABC News", "https://news.google.com/rss/search?q=abc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("NBC News", "https://news.google.com/rss/search?q=nbc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("USA Today", "https://news.google.com/rss/search?q=usa+today+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Christian Science Monitor", "https://news.google.com/rss/search?q=christian+science+monitor+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Hill", "https://news.google.com/rss/search?q=the+hill+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("CNBC", "https://news.google.com/rss/search?q=cnbc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Forbes", "https://news.google.com/rss/search?q=forbes+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Financial Times", "https://news.google.com/rss/search?q=financial+times+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("BBC News", "https://news.google.com/rss/search?q=bbc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Guardian US", "https://news.google.com/rss/search?q=the+guardian+us+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Los Angeles Times", "https://news.google.com/rss/search?q=los+angeles+times+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Chicago Tribune", "https://news.google.com/rss/search?q=chicago+tribune+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Boston Globe", "https://news.google.com/rss/search?q=boston+globe+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Philadelphia Inquirer", "https://news.google.com/rss/search?q=philadelphia+inquirer+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Seattle Times", "https://news.google.com/rss/search?q=seattle+times+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Denver Post", "https://news.google.com/rss/search?q=denver+post+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Arizona Republic", "https://news.google.com/rss/search?q=arizona+republic+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Star Tribune Minneapolis", "https://news.google.com/rss/search?q=star+tribune+minneapolis+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Oregonian", "https://news.google.com/rss/search?q=oregonian+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Sacramento Bee", "https://news.google.com/rss/search?q=sacramento+bee+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The San Francisco Chronicle", "https://news.google.com/rss/search?q=san+francisco+chronicle+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Dallas Morning News", "https://news.google.com/rss/search?q=dallas+morning+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Atlanta Journal-Constitution", "https://news.google.com/rss/search?q=atlanta+journal+constitution+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Miami Herald", "https://news.google.com/rss/search?q=miami+herald+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("ProPublica", "https://news.google.com/rss/search?q=propublica+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Pew Research Center", "https://news.google.com/rss/search?q=pew+research+center+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Brookings Institution", "https://news.google.com/rss/search?q=brookings+institution+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("RAND Corporation", "https://news.google.com/rss/search?q=rand+corporation+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Council on Foreign Relations", "https://news.google.com/rss/search?q=council+on+foreign+relations+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Texas Tribune", "https://news.google.com/rss/search?q=texas+tribune+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Politico Magazine", "https://news.google.com/rss/search?q=politico+magazine+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Roll Call", "https://news.google.com/rss/search?q=roll+call+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("CQ Roll Call", "https://news.google.com/rss/search?q=cq+roll+call+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("National Journal", "https://news.google.com/rss/search?q=national+journal+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Cook Political Report", "https://news.google.com/rss/search?q=cook+political+report+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Ballotpedia", "https://news.google.com/rss/search?q=ballotpedia+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("RealClearPolitics", "https://news.google.com/rss/search?q=realclearpolitics+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("FactCheck.org", "https://news.google.com/rss/search?q=factcheck.org+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("PolitiFact", "https://news.google.com/rss/search?q=politifact+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Snopes politics section", "https://news.google.com/rss/search?q=snopes+politics+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Dispatch", "https://news.google.com/rss/search?q=the+dispatch+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Notus", "https://news.google.com/rss/search?q=notus+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Punchbowl News", "https://news.google.com/rss/search?q=punchbowl+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Semafor", "https://news.google.com/rss/search?q=semafor+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Puck News", "https://news.google.com/rss/search?q=puck+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Bulwark", "https://news.google.com/rss/search?q=the+bulwark+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Ground News aggregator view", "https://news.google.com/rss/search?q=ground+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("AllSides aggregator view", "https://news.google.com/rss/search?q=allsides+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("NewsGuard-rated national outlets", "https://news.google.com/rss/search?q=newsguard+rated+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("McClatchy DC Bureau", "https://news.google.com/rss/search?q=mcclatchy+dc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Hearst Newspapers Washington Bureau", "https://news.google.com/rss/search?q=hearst+newspapers+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Gannett DC Bureau", "https://news.google.com/rss/search?q=gannett+dc+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Tribune News Service", "https://news.google.com/rss/search?q=tribune+news+service+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Bloomberg Government", "https://news.google.com/rss/search?q=bloomberg+government+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("E&E News energy policy", "https://news.google.com/rss/search?q=e+e+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Stat News health policy", "https://news.google.com/rss/search?q=stat+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Defense News", "https://news.google.com/rss/search?q=defense+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Cipher Brief", "https://news.google.com/rss/search?q=the+cipher+brief+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Just Security", "https://news.google.com/rss/search?q=just+security+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Lawfare Blog", "https://news.google.com/rss/search?q=lawfare+blog+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("SCOTUSblog", "https://news.google.com/rss/search?q=scotusblog+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("OpenSecrets.org campaign finance", "https://news.google.com/rss/search?q=opensecrets+campaign+finance+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("The Markup tech policy", "https://news.google.com/rss/search?q=the+markup+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Stateline state-federal policy", "https://news.google.com/rss/search?q=stateline+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Governing Magazine", "https://news.google.com/rss/search?q=governing+magazine+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Route Fifty federal workforce", "https://news.google.com/rss/search?q=route+fifty+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Government Executive", "https://news.google.com/rss/search?q=government+executive+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Federal News Network", "https://news.google.com/rss/search?q=federal+news+network+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Defense One", "https://news.google.com/rss/search?q=defense+one+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("War on the Rocks", "https://news.google.com/rss/search?q=war+on+the+rocks+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("National Defense Magazine", "https://news.google.com/rss/search?q=national+defense+magazine+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Foreign Policy Situation Report", "https://news.google.com/rss/search?q=foreign+policy+situation+report+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Just the News center-leaning national desk", "https://news.google.com/rss/search?q=just+the+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("NewsNation", "https://news.google.com/rss/search?q=newsnation+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en"),
    ("Straight Arrow News", "https://news.google.com/rss/search?q=straight+arrow+news+trump+OR+biden+OR+harris+OR+congress+OR+election&hl=en-US&gl=US&ceid=US:en")
]
...
<body>
    ...
    <!-- US News – tiny gap only (columns fully restored) -->
