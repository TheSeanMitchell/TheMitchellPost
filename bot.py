...
US_POLITICS_SOURCES = [
    ...
    ("CQ Roll Call", "https://news.google.com/rss/search?q=when:1d+site:rollcall.com&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("Snopes politics section", "https://news.google.com/rss/search?q=when:1d+site:snopes.com&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("Puck News", "https://news.google.com/rss/search?q=when:1d+site:puck.news&hl=en-US&gl=US&ceid=US:en"),
    ("The Bulwark", "https://news.google.com/rss/search?q=when:1d+site:thebulwark.com&hl=en-US&gl=US&ceid=US:en"),
    ("Ground News aggregator view", "https://news.google.com/rss/search?q=when:1d+site:ground.news&hl=en-US&gl=US&ceid=US:en"),
    ("AllSides aggregator view", "https://news.google.com/rss/search?q=when:1d+site:allsides.com&hl=en-US&gl=US&ceid=US:en"),
    ("NewsGuard-rated national outlets", "https://news.google.com/rss/search?q=when:1d+newsguard&hl=en-US&gl=US&ceid=US:en"),
    ("McClatchy DC Bureau", "https://news.google.com/rss/search?q=when:1d+site:mcclatchydc.com&hl=en-US&gl=US&ceid=US:en"),
    ("Hearst Newspapers Washington Bureau", "https://news.google.com/rss/search?q=when:1d+site:hearst.com&hl=en-US&gl=US&ceid=US:en"),
    ("Gannett DC Bureau", "https://news.google.com/rss/search?q=when:1d+site:gannett.com&hl=en-US&gl=US&ceid=US:en"),
    ("Tribune News Service", "https://news.google.com/rss/search?q=when:1d+site:tribunemedia.com&hl=en-US&gl=US&ceid=US:en"),
    ("Bloomberg Government", "https://news.google.com/rss/search?q=when:1d+site:bgov.com&hl=en-US&gl=US&ceid=US:en"),
    ("E&E News energy policy", "https://news.google.com/rss/search?q=when:1d+site:eenews.net&hl=en-US&gl=US&ceid=US:en"),
    ("Stat News health policy", "https://news.google.com/rss/search?q=when:1d+site:statnews.com&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("OpenSecrets.org campaign finance", "https://news.google.com/rss/search?q=when:1d+site:opensecrets.org&hl=en-US&gl=US&ceid=US:en"),
    ("The Markup tech policy", "https://news.google.com/rss/search?q=when:1d+site:themarkup.org&hl=en-US&gl=US&ceid=US:en"),
    ("Stateline state-federal policy", "https://news.google.com/rss/search?q=when:1d+site:stateline.org&hl=en-US&gl=US&ceid=US:en"),
    ("Governing Magazine", "https://news.google.com/rss/search?q=when:1d+site:governing.com&hl=en-US&gl=US&ceid=US:en"),
    ("Route Fifty federal workforce", "https://news.google.com/rss/search?q=when:1d+site:route-fifty.com&hl=en-US&gl=US&ceid=US:en"),
    ...
    ("Foreign Policy Situation Report", "https://news.google.com/rss/search?q=when:1d+site:foreignpolicy.com/situation-report&hl=en-US&gl=US&ceid=US:en"),
    ("Just the News center-leaning national desk", "https://news.google.com/rss/search?q=when:1d+site:justthenews.com&hl=en-US&gl=US&ceid=US:en"),
